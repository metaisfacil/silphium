...
const createScope = () => {
    ...
    return {
        ...
        sidebarQueueBrowserActionsDivider: document.createElement('hr'),
        ...
        openSidebarQueueItemInFileBrowser: vi.fn(),
...
describe('app-bootstrap-setup wrappers', () => {
    ...
    it('maps event binding callbacks and live getters from scope', async () => {
        ...
        expect(context.tracks).toBe(scope.tracks);
        expect(context.openSidebarQueueMenu).toBe(scope.openSidebarQueueMenu);
