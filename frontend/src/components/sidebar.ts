export type SidebarElements = {
  ...
  libraryHeaderTitleText: HTMLSpanElement;
  ...
  sidebarNavPane: HTMLElement;
  sidebarNavOverview: HTMLButtonElement;
  sidebarNavLibrary: HTMLButtonElement;
  sidebarNavSocial: HTMLButtonElement;
  sidebarModeBar: HTMLElement;
  sidebarModeBack: HTMLButtonElement;
...
export const renderSidebar = (): string => `
    <button id="sidebar-toggle" class="sidebar-toggle" type="button" aria-label="Open sidebar">
      <span class="sidebar-toggle-content" aria-hidden="true">
        <span class="sidebar-toggle-icon-stack">
          <svg class="sidebar-toggle-icon sidebar-toggle-icon-menu" width="14" height="14" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M4 6.5C4 5.67 4.67 5 5.5 5H18.5C19.33 5 20 5.67 20 6.5C20 7.33 19.33 8 18.5 8H5.5C4.67 8 4 7.33 4 6.5ZM4 12C4 11.17 4.67 10.5 5.5 10.5H18.5C19.33 10.5 20 11.17 20 12C20 12.83 19.33 13.5 18.5 13.5H5.5C4.67 13.5 4 12.83 4 12ZM4 17.5C4 16.67 4.67 16 5.5 16H18.5C19.33 16 20 16.67 20 17.5C20 18.33 19.33 19 18.5 19H5.5C4.67 19 4 18.33 4 17.5Z"/></svg>
          <svg class="sidebar-toggle-back-icon" width="14" height="14" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M14.53 5.47C15.12 6.06 15.12 7.01 14.53 7.6L10.12 12L14.53 16.4C15.12 16.99 15.12 17.94 14.53 18.53C13.94 19.12 12.99 19.12 12.4 18.53L6.94 13.06C6.35 12.47 6.35 11.53 6.94 10.94L12.4 5.47C12.99 4.88 13.94 4.88 14.53 5.47Z"/></svg>
        </span>
        <span class="sidebar-toggle-text">Back</span>
      </span>
      <span class="sidebar-toggle-loading-label" aria-hidden="true"></span>
    </button>
    ...
    <aside id="library-sidebar" class="library-sidebar" aria-hidden="true">
      ...
      <section id="sidebar-nav-pane" class="sidebar-pane sidebar-pane-nav">
        <div class="sidebar-nav-list">
          <button id="sidebar-nav-overview" class="sidebar-nav-item" type="button">Overview</button>
          <button id="sidebar-nav-library" class="sidebar-nav-item" type="button">Library</button>
          <button id="sidebar-nav-social" class="sidebar-nav-item" type="button">Social</button>
        </div>
      </section>
      <div id="sidebar-mode-bar" class="sidebar-mode-bar" hidden>
        <button id="sidebar-mode-back" class="sidebar-mode-back" type="button" aria-label="Back to sidebar navigation"><svg class="library-back-icon" width="14" height="14" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M14.53 5.47C15.12 6.06 15.12 7.01 14.53 7.6L10.12 12L14.53 16.4C15.12 16.99 15.12 17.94 14.53 18.53C13.94 19.12 12.99 19.12 12.4 18.53L6.94 13.06C6.35 12.47 6.35 11.53 6.94 10.94L12.4 5.47C12.99 4.88 13.94 4.88 14.53 5.47Z"/></svg><span>Back</span></button>
      </div>
...
export const getSidebarElements = (root: ParentNode): SidebarElements => ({
  ...
  libraryExpandToggle: root.querySelector('#library-expand-toggle') as HTMLButtonElement,
    ...
    sidebarNavOverview: root.querySelector('#sidebar-nav-overview') as HTMLButtonElement,
    sidebarNavLibrary: root.querySelector('#sidebar-nav-library') as HTMLButtonElement,
    sidebarNavSocial: root.querySelector('#sidebar-nav-social') as HTMLButtonElement,
    sidebarModeBar: root.querySelector('#sidebar-mode-bar') as HTMLElement,
    sidebarModeBack: root.querySelector('#sidebar-mode-back') as HTMLButtonElement,
