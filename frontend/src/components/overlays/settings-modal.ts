        ...
        <section class="settings-dialog" role="dialog" aria-modal="true" aria-labelledby="settings-title">
            ...
            <div class="settings-content">
                ...
                <div id="settings-panel-audio" class="settings-panel" role="tabpanel" aria-labelledby="settings-tab-audio" hidden>
                    ...
                    <div class="settings-field settings-toggle-field">
                        ${renderSettingsCheckboxLabel('settings-replaygain', 'Enable ReplayGain', 'Reads ReplayGain tags when present and scans individual tracks without them before playback. Album ReplayGain should be pre-tagged in the library when needed.')}
                    </div>
                </div>
                <div id="settings-panel-ui" class="settings-panel" role="tabpanel" aria-labelledby="settings-tab-ui" hidden>
                    <div id="settings-ui-layout-grid" tabindex="-1">
                        <div id="settings-roon-accent-field" class="settings-field">
                            ${renderSettingsLabel('settings-roon-accent-color', 'Accent colour', 'Tints the Roon-inspired shell chrome. Lower saturation for a more neutral treatment.')}
