...
export const resolvePrimaryTab = (tab: 'general' | 'library' | 'network' | 'database' | 'playlists' | 'scrobbling' | 'audio' | 'ui' | 'actions' | 'shortcuts'): 'general' | 'library' | 'network' | 'playlists' | 'scrobbling' | 'audio' | 'ui' | 'actions' => {
    if (tab === 'shortcuts') {
        return 'ui';
    }
