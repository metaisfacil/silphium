...
export function GetProfilerHTTPAddress():Promise<string>;
...
export function StartProfilerSession():Promise<boolean>;

export function StopProfilerSession():Promise<boolean>;
